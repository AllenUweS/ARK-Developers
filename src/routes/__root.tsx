...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Manage projects, plots and plot bookings for ARK Builders & Developers." },
      { property: "og:title", content: "ARK Developers — Land & Plotted Development Platform" },
      { property: "og:description", content: "Manage projects, plots and plot bookings for ARK Builders & Developers." },
